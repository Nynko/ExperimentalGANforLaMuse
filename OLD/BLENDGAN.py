###
# Model based on RM-NET : https://github.com/Jireh-Jam/R-MNet-Inpainting-keras
###
...
import time
import gc
from config.config import BATCH_SIZE, CHANNELS, CURRENT_EPOCH, CURRNT_EPOCH, GEN_FILTER, IMG_HEIGHT, IMG_WIDTH, LAST_TRAINED_EPOCH, NUM_EPOCHS, SAMPLE_INTERVAL
...
class BLENDGAN():
    def __init__(self,config):
        ...
        self.last_trained_epoch = LAST_TRAINED_EPOCH
        
        #Folders
        self.dataset_name = 'BLENDGAN_SET'
        self.models_path = 'models'
        
        #Configure Loader
        self.img_dir = r'./images/train/'
        ...
        #Optimizer
        self.g_optimizer = tf.keras.optimizers.Adam(lr=config.g_learning_rate, 
                                beta_1=config.beta_1, 
                                beta_2=config.beta_2, 
                                epsilon=config.epsilon)
        self.d_optimizer = tf.keras.optimizers.Adam(lr=config.d_learning_rate, 
                                beta_1=config.beta_1, 
                                beta_2=config.beta_2, 
                                epsilon=config.epsilon)
    ...
    # =================================================================================== #         
        ...
        try:
            self.multi_model = tf.keras.utils.multi_gpu_model(self.combined, gpus=2)
